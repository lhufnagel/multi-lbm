...
\title{USING SIAM'S MULTIMEDIA \LaTeX\ MACROS\thanks{This work was
...
(\email{multimedia@siam.org}). Questions, comments, or corrections
...
\begin{abstract}
Documentation is given for use of the SIAM multimedia \LaTeX\ macros. These
macros are compatible with \LaTeX$2_{\varepsilon}$.
...
This file is documentation for the SIAM Multimedia \LaTeX\ macros, and
...
to SIAM style standards, SIAM provides a multimedia \LaTeX\ macro style file.
...
siamltexmm.cls}, the main multimedia macro package; 
{\tt siam11.clo}, for the eleven-point size option; 
{\tt subeqn.clo}, a style option for equation numbering (see \S3 for
an explanation); and  {\tt siam.bst},
 the style file for use with {\sc Bib}\TeX. Also included is this
file {\tt docultexmm.tex}.
...
\item[oneeqnum] Normally \verb|siamltexmm.cls| numbers equations,
...
\footnotetext[5]{Support in common for the first and second authors.}
...
{\tt siamltexmm.cls} includes definitions of two alternate list
