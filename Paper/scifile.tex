...
\\
\normalsize{$^{1}$Chair for System-Simulation, Friedrich Alexander Univerität Erlangen-Nürnberg}\\
...
\begin{sciabstract}
  We implemented the lattice Boltzman method for immiscible multiphase flow simulations. We combined this with the level set method according to the paper of G. Thömmes FUSSNOTE. After reimplementing the testcases mentioned in the paper, we studied the coupling of the two methods and the impact of the variables.
\end{sciabstract}
...
\newpage
Hier folgen Informationen über das Stylesheet. Sollten wir dann irgendwann loeschen, fand ich aber fuers erste ganz hilfreich.
